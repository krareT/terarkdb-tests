...
../build/Terark_Engine_Test terarkdb -read_percent=0 -insert_percent=0 -load_or_run=run -insert_data_path=$insert_file --sync_index=1 --db=$dirname --threads=8 -keys_data_path=$keys_file -load_data_path=$load_file
