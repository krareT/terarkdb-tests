...
wget nark.cc/download/terark-zip-rocksdb-Linux-x86_64-g++-5.3-bmi2-1.tgz	

tar zxvf ./terark-db-Linux-x86_64-g++-5.3-bmi2-1.tgz
tar zxvf ./terark-fsa_all-Linux-x86_64-g++-5.3-bmi2-1.tgz
tar zxvf ./terark-zip-rocksdb-Linux-x86_64-g++-5.3-bmi2-1.tgz

cp ./pkg/terark-fsa_all-Linux-x86_64-g++-5.3-bmi2-1/* ./pkg/terark-db-Linux-x86_64-g++-5.3-bmi2-1/ -r
cp ./pkg/terark-zip-rocksdb-Linux-x86_64-g++-5.3-bmi2-1/* ./pkg/terark-db-Linux-x86_64-g++-5.3-bmi2-1/ -r
rm ~/Documents/pkg -rf
cp ./pkg ~/Documents/ -r
cd ../
